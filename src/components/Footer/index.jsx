...
import insignia__logo from "../../assets/logo/churchlogo.png";
import { footerServices } from "../../constants/footer";

export default function Footer() {
  const year = new Date().getFullYear();

  return (
    <section className="relative bg-section__bg_color py-5 px-2 border-t">
      ...
      <div className="max-w-screen-xl mx-auto relative">
          ...
          <div>
            <HashLink to={"/#"}>
              <img
                src={insignia__logo}
                alt="Insigina__logo"
                className="w-[80px] md:w-[200px] xl:w-[250px]"
              />
            </HashLink>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center xl:items-start md:flex-row justify-between">
