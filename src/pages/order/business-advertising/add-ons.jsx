...
export default function OrderAddOnsScreen() {
  ...
  const handleSubmit = () => {
    ...
    navigate(`/order/business-advertising/review/${id}#review`);
  };

  return (
    <Layout title="Add ons" sectionHeight="10vh">
      {isFetching ? (
        <Loader />
      ) : (
        <Box id="add-ons" className="bg-section__bg_color">
          ...
          {!data && !isFetching ? (
            ...
            <Box className="border border-blue-600 h-full flex flex-col gap-10 justify-between">
