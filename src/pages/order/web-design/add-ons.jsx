...
export default function OrderAddOnsScreen() {
  ...
  const programmingLangs = packageData?.featuredProgrammingLangs.concat(
    packageData?.additionalProgrammingLangs
  );
  ...
  const handleSubmit = () => {
    ...
    navigate(`/order/web-design/review/${id}#review`);
  };
          ...
          {!data && !isFetching ? (
            ...
            <Box className="flex flex-col gap-10">
              <Box className="max-w-[1000px] w-full mx-auto py-10 container">
                {programmingLangs && programmingLangs?.length > 0 && (
                  <>
                    <Box className="flex flex-col md:flex-row justify-between gap-y-5 mb-10 md:mb-0">
                      ...
                      <Box className="flex-1">
                        <Select
                          isClearable
                          isSearchable
                          onChange={handleProgrammingLang}
                          closeMenuOnSelect={true}
                          components={animatedComponents}
                          defaultValue={selectedProgrammingLang}
