...
export default function PackageLogoAndBrandIdentityScreen() {
  const scrollWithOffset = useScrollWithOffset();

  return (
    <Layout title="Logo & Brand Identity">
      <section id="logo-and-brand-identity">
          ...
          <div className="container px-4 flex flex-col md:flex-row justify-between items-center gap-5 py-10 xl:py-20">
            <div className="basis-[100%] md:basis-[50%]">
              ...
              <div className="flex items-center gap-5 mt-4">
                ...
                <HashLink
                  to="/package/branding/logo-and-brand-identity#package-faq"
