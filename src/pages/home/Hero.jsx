        ...
        <div className="flex flex-col-reverse lg:flex-row justify-between">
          ...
          <div className="flex-1 flex justify-center p-2.5">
            <div className="w-full xl:p-10 ">
              <h2 className="text-brand__black__color text-[50px] lg:text-[60px] xl:text-[80px] leading-[55px] xl:leading-[80px] lg:leading-[65px] font-brand__font__semibold text-center lg:text-left">
