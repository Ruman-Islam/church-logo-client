        ...
        <div className="flex-1 flex items-end container text-brand__black__color gap-5">
          ...
          <div className="basis-[100%] xl:basis-[70%] h-full md:mb-6">
            <div className="border-b border-brand__black__color flex justify-between items-end w-full p-2">
              <div className="flex-grow h-full text-brand__black__color text-[32px]  md:text-brand__font__size__lg2 font-brand__font__semibold leading-tight">
            ...
            <div className="text-text__gray px-2 py-3 leading-tight font-brand__font__500 flex items-center gap-x-1">
